...
inline void OpenSpaceToolkitPhysicsPy_Data_Manifest(pybind11::module& aModule)
{
    ...
    ManifestClass
        ...
        .def(
            ...
            &Manifest::getLastModifiedTimestamp,
            R"doc(
        ...
        .def(
            ...
            &Manifest::getLastUpdateTimestampFor,
            arg("data_name"),
            R"doc(
        ...
        .def(
            ...
            &Manifest::getNextUpdateCheckTimestampFor,
            arg("data_name"),
            R"doc(
