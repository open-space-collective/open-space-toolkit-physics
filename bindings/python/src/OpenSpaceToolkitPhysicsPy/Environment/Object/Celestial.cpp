...
inline void OpenSpaceToolkitPhysicsPy_Environment_Object_Celestial(pybind11::module& aModule)
{
    ...
    celestial_class
        ...
        .def(
            ...
            &Celestial::accessGravitationalModel,
            R"doc(
        ...
        .def(
            ...
            &Celestial::accessAtmosphericModel,
            R"doc(
        ...
        .def(
            ...
            &Celestial::getGravitationalParameter,
            R"doc(
        ...
        .def(
            ...
            arg("instant"),
            R"doc(
                Compute the position of the celestial object using a fast low-precision analytical model, in GCRF.

                Unlike Celestial.get_position_in, this does not utilize on the ephemeris of the celestial object.

                Only defined for the celestial objects providing an analytical model.
        ...
        .def(
            ...
            &Celestial::gravitationalModelIsDefined,
            R"doc(
        ...
        .def(
            ...
            &Celestial::magneticModelIsDefined,
            R"doc(
        ...
        .def(
            ...
            &Celestial::atmosphericModelIsDefined,
            R"doc(
