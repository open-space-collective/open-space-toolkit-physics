...
def test_spherical_constructor ():
    ...
    spherical_gravitational_model: SphericalGravitationalModel = SphericalGravitationalModel(EGM2008.gravitational_parameter)

    assert spherical_gravitational_model is not None
    assert isinstance(spherical_gravitational_model, SphericalGravitationalModel)

################################################################################################################################################################

def test_spherical_get_field_value_at ():
