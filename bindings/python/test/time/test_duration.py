...
class TestDuration:
    ...
    def test_constructor_success_timedelta (self):
        ...
        assert Duration(timedelta(seconds = 123, microseconds = 456000)).in_seconds() == 123.456
        assert Duration(timedelta(seconds = 123, microseconds = 456)).in_seconds() == 123.000456
