...
def closed_interval () -> Interval:
    ...
    return Interval(Instant.J2000(), Instant.J2000() + Duration.minutes(1.0), Interval.Type.Closed)

@pytest.fixture
def open_interval () -> Interval:

    return Interval(Instant.J2000(), Instant.J2000() + Duration.minutes(1.0), Interval.Type.Open)

@pytest.fixture
def half_open_right_interval () -> Interval:

    return Interval(Instant.J2000(), Instant.J2000() + Duration.minutes(1.0), Interval.Type.HalfOpenRight)

@pytest.fixture
def half_open_left_interval () -> Interval:

    return Interval(Instant.J2000(), Instant.J2000() + Duration.minutes(1.0), Interval.Type.HalfOpenLeft)
...
def interval_2 () -> Interval:
    ...
    return Interval(Instant.J2000() - Duration.minutes(1.0), Instant.J2000(), Interval.Type.Closed)

@pytest.fixture
def interval_3 () -> Interval:

    return Interval(Instant.J2000() - Duration.minutes(2.0), Instant.J2000() - Duration.minutes(1.0), Interval.Type.Closed)
...
class TestInterval:
    ...
    def test_interval_constructor (self):
        ...
        interval: Interval = Interval(Instant.J2000(), Instant.J2000() + Duration.minutes(1.0), Interval.Type.Closed)

        assert interval is not None
        assert isinstance(interval, Interval)

        with pytest.raises(RuntimeError):
            Interval(Instant.J2000() + Duration.seconds (1.0), Instant.J2000(), Interval.Type.Closed)
    ...
    def test_interval_constructor_open (self):
        ...
        assert Interval(Instant.J2000(), Instant.J2000() + Duration.minutes(1.0), Interval.Type.Open) is not None

    def test_interval_constructor_half_open_left (self):

        assert Interval(Instant.J2000(), Instant.J2000() + Duration.minutes(1.0), Interval.Type.HalfOpenLeft) is not None

    def test_interval_constructor_half_open_right (self):

        assert Interval(Instant.J2000(), Instant.J2000() + Duration.minutes(1.0), Interval.Type.HalfOpenRight) is not None

    def test_interval_constructor_centered (self):

        assert Interval.centered(Instant.J2000(), Duration.minutes(1.0), Interval.Type.Closed) is not None
        assert Interval.centered(Instant.J2000(), Duration.minutes(1.0), Interval.Type.Open) is not None
        assert Interval.centered(Instant.J2000(), Duration.minutes(1.0), Interval.Type.HalfOpenLeft) is not None
        assert Interval.centered(Instant.J2000(), Duration.minutes(1.0), Interval.Type.HalfOpenRight) is not None

    def test_interval_operator_equality (self,
                                         interval_1: Interval,
                                         interval_4: Interval):
    ...
    def test_interval_is_degenerate (self,
        ...
        assert Interval(Instant.J2000(), Instant.J2000(), Interval.Type.Open).is_degenerate()
        assert Interval.centered(Instant.J2000(), Duration.minutes(0.0), Interval.Type.Open).is_degenerate()
    ...
    def test_interval_contains_interval (self,
        ...
        assert interval_1.contains_interval(Interval.closed(Instant.J2000() + Duration.seconds(1.0), Instant.J2000() + Duration.seconds(2.0)))

    def test_interval_get_properties (self,
                                      interval: Interval):
    ...
    def test_interval_generate_grid (self,
                                     interval: Interval):
