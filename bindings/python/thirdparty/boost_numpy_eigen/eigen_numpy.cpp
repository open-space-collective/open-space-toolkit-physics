...
struct EigenTransformFromPython
{
    ...
    {
        bp::converter::registry::push_back(&convertible, &construct, bp::type_id<TransformType>());
    }
...
struct EigenTensorFromPython
{
    ...
    {
        bp::converter::registry::push_back(&convertible, &construct, bp::type_id<TensorType>());
    }
    ...
    static void construct(PyObject* obj_ptr, bp::converter::rvalue_from_python_stage1_data* data)
    {
        ...
        void* storage = ((bp::converter::rvalue_from_python_storage<TensorType>*)(data))->storage.bytes;
