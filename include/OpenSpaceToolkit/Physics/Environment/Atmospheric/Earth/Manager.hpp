...
/// @file           OpenSpaceToolkit/Physics/Environment/Atmospheric/Earth/Manager.hpp
...
#define OSTK_PHYSICS_ENVIRONMENT_ATMOSPHERIC_EARTH_MANAGER_ENABLED true
#define OSTK_PHYSICS_ENVIRONMENT_ATMOSPHERIC_EARTH_MANAGER_LOCAL_REPOSITORY "./.open-space-toolkit/physics/environment/atmospheric/earth"
#define OSTK_PHYSICS_ENVIRONMENT_ATMOSPHERIC_EARTH_MANAGER_REMOTE_URL "https://sourceforge.net/projects/geographiclib/files/gravity-distrib/"
...
/// @brief                      Earth atmospheric model data manager
///
///                             Fetches and manages necessary gravity model data files.
///
///                             The following environment variables can be defined:
///
///                             - "OSTK_PHYSICS_ENVIRONMENT_ATMOSPHERIC_EARTH_MANAGER_ENABLED" will override "DefaultEnabled"
///                             - "OSTK_PHYSICS_ENVIRONMENT_ATMOSPHERIC_EARTH_MANAGER_LOCAL_REPOSITORY" will override "DefaultLocalRepository"
///                             - "OSTK_PHYSICS_ENVIRONMENT_ATMOSPHERIC_EARTH_MANAGER_REMOTE_URL" will override "DefaultRemoteUrl"
...
class Manager
{
    ...
    public:
        ...
        bool                    hasDataFileForType                          (   const   EarthAtmosphericModel::Type& aModelType                               ) const ;
        ...
        void                    fetchDataFileForType                        (   const   EarthAtmosphericModel::Type& aModelType                               ) const ;
        ...
        ///
        ///                     Overriden by: OSTK_PHYSICS_ENVIRONMENT_ATMOSPHERIC_EARTH_MANAGER_ENABLED
        ///
    ...
    private:
        ...
        URL                     getDataFileUrlForType                       (   const   EarthAtmosphericModel::Type& aModelType                               ) const ;

        static String           DataFileNameFromType                        (   const   EarthAtmosphericModel::Type& aModelType                               ) ;
