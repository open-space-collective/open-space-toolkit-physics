...
#ifndef __OpenSpaceToolkit_Physics_Coordinate_Frame_Providers_IERS_CSSISpaceWeather__
#define __OpenSpaceToolkit_Physics_Coordinate_Frame_Providers_IERS_CSSISpaceWeather__
...
class CSSISpaceWeather
{
   ...
   private:
    ...
    Map<Integer, CSSISpaceWeather::Prediction> predictions_;
