...
class Manager : public BaseManager
{
   public:
    ...
    ///
    /// @code
    ///     Array<Kernel> kernels = Manager::Get().fetchMatchingKernels("de432s.*\\.bsp");
    /// @endcode
    ///
    ...
    ///
    /// @code
    ///     Array<Path> paths = Manager::Get().findKernelPaths("de432s.*\\.bsp");
    /// @endcode
    ///
    ...
    ///
    /// @code
    ///     Kernel kernel = Manager::Get().findKernel("de432s.*\\.bsp");
    /// @endcode
    ///
    /// @param [in] aRegexString A regular expression
    /// @return An array of kernels
