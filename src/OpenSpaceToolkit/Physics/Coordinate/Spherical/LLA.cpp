...
/// @file           OpenSpaceToolkit/Physics/Coordinate/Spherical/LLA.cpp
...
LLA                             LLA::Cartesian                              (   const   Vector3d&                   aCartesianCoordinateSet,
                                                                                ...
                                                                                const   Real&                       anEllipsoidFlattening                       )
{
    ...
    const int result = iauGc2gde(anEllipsoidEquatorialRadius.inMeters(), anEllipsoidFlattening, Vector3d(aCartesianCoordinateSet).data(), &longitude_rad, &latitude_rad, &altitude_m) ;
