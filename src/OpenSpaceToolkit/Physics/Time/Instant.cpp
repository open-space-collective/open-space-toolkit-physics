...
Int64 Instant::dAT_UTC(const Instant::Count& aCount_UTC)
{
    ...
    if (aCount_UTC.postEpoch_)
    {
        static const Array<Triple<Uint64, Uint64, Int64>> dATMap = {
            {536500800000000000,
             999999999999999999,
             37000000000},  // December 2016    >   +Inf            : dAT =   37 [s]
            {488980800000000000,
             536500800000000000,
             36000000000},  // June 2015        >   December 2016   : dAT =   36 [s]
            {394372800000000000,
             488980800000000000,
             35000000000},  // June 2012        >   June 2015       : dAT =   35 [s]
            {284040000000000000,
             394372800000000000,
             34000000000},  // December 2008    >   June 2012       : dAT =   34 [s]
            {189345600000000000,
             284040000000000000,
             33000000000},  // December 2005    >   December 2008   : dAT =   33 [s]
            {000000000000000000,
             189345600000000000,
             32000000000}  // Epoch            >   December 2005   : dAT =   32 [s]
        };
    ...
    else
    {
        static const Array<Triple<Uint64, Uint64, Int64>> dATMap = {
            {000000000000000000,
             31579200000000000,
             32000000000},  // Epoch            <   December 1998   : dAT =   32 [s]
            {31579200000000000,
             79012800000000000,
             31000000000},  // December 1998    <   June 1997       : dAT =   31 [s]
            {79012800000000000,
             126273600000000000,
             30000000000},  // June 1997        <   December 1995   : dAT =   30 [s]
            {126273600000000000,
             173707200000000000,
             29000000000},  // December 1995    <   June 1994       : dAT =   29 [s]
            {173707200000000000,
             205243200000000000,
             28000000000},  // June 1994        <   June 1993       : dAT =   28 [s]
            {205243200000000000,
             236779200000000000,
             27000000000},  // June 1993        <   June 1992       : dAT =   27 [s]
            {236779200000000000,
             284040000000000000,
             26000000000},  // June 1992        <   December 1990   : dAT =   26 [s]
            {284040000000000000,
             315576000000000000,
             25000000000},  // December 1990    <   December 1989   : dAT =   25 [s]
            {315576000000000000,
             378734400000000000,
             24000000000},  // December 1989    <   December 1987   : dAT =   24 [s]
            {378734400000000000,
             457704000000000000,
             23000000000},  // December 1987    <   June 1985       : dAT =   23 [s]
            {457704000000000000,
             520862400000000000,
             22000000000},  // June 1985        <   June 1983       : dAT =   22 [s]
            {520862400000000000,
             552398400000000000,
             21000000000},  // June 1983        <   June 1982       : dAT =   21 [s]
            {552398400000000000,
             583934400000000000,
             20000000000},  // June 1982        <   June 1981       : dAT =   20 [s]
            {583934400000000000,
             631195200000000000,
             19000000000},  // June 1981        <   December 1979   : dAT =   19 [s]
            {631195200000000000,
             662731200000000000,
             18000000000},  // December 1979    <   December 1978   : dAT =   18 [s]
            {662731200000000000,
             694267200000000000,
             17000000000},  // December 1978    <   December 1977   : dAT =   17 [s]
            {694267200000000000,
             725803200000000000,
             16000000000},  // December 1977    <   December 1976   : dAT =   16 [s]
            {725803200000000000,
             757425600000000000,
             15000000000},  // December 1976    <   December 1975   : dAT =   15 [s]
            {757425600000000000,
             788961600000000000,
             14000000000},  // December 1975    <   December 1974   : dAT =   14 [s]
            {788961600000000000,
             820497600000000000,
             13000000000},  // December 1974    <   December 1973   : dAT =   13 [s]
            {820497600000000000,
             852033600000000000,
             12000000000},  // December 1973    <   December 1972   : dAT =   12 [s]
            {852033600000000000,
             867931200000000000,
             11000000000},  // December 1972    <   June 1972       : dAT =   11 [s]
            {867931200000000000,
             999999999999999999,
             10000000000}  // June 1972        <   Start           : dAT =   10 [s]
        };
...
Int64 Instant::dAT_TAI(const Instant::Count& aCount_TAI)
{
    ...
    {
        static const Array<Triple<Uint64, Uint64, Int64>> dATMap = {
            {536500800000000000 + 36000000000,
             999999999999999999 + 00000000000,
             37000000000},  // December 2016    >   +Inf            : dAT =   37 [s]
            {488980800000000000 + 35000000000,
             536500800000000000 + 36000000000,
             36000000000},  // June 2015        >   December 2016   : dAT =   36 [s]
            {394372800000000000 + 34000000000,
             488980800000000000 + 35000000000,
             35000000000},  // June 2012        >   June 2015       : dAT =   35 [s]
            {284040000000000000 + 33000000000,
             394372800000000000 + 34000000000,
             34000000000},  // December 2008    >   June 2012       : dAT =   34 [s]
            {189345600000000000 + 32000000000,
             284040000000000000 + 33000000000,
             33000000000},  // December 2005    >   December 2008   : dAT =   33 [s]
            {000000000000000000 + 31000000000,
             189345600000000000 + 32000000000,
             32000000000},  // Epoch - 31 [s]   >   December 2005   : dAT =   32 [s]
            {000000000000000000 + 00000000000,
             000000000000000000 + 31000000000,
             32000000000}  // Epoch            >   Epoch - 31 [s]  : dAT =   32 [s]
        };
    ...
    else
    {
        static const Array<Triple<Uint64, Uint64, Int64>> dATMap = {
            {000000000000000000 - 00000000000,
             31579200000000000 - 31000000000,
             32000000000},  // Epoch            <   December 1998   : dAT =   32 [s]
            {31579200000000000 - 31000000000,
             79012800000000000 - 30000000000,
             31000000000},  // December 1998    <   June 1997       : dAT =   31 [s]
            {79012800000000000 - 30000000000,
             126273600000000000 - 29000000000,
             30000000000},  // June 1997        <   December 1995   : dAT =   30 [s]
            {126273600000000000 - 29000000000,
             173707200000000000 - 28000000000,
             29000000000},  // December 1995    <   June 1994       : dAT =   29 [s]
            {173707200000000000 - 28000000000,
             205243200000000000 - 27000000000,
             28000000000},  // June 1994        <   June 1993       : dAT =   28 [s]
            {205243200000000000 - 27000000000,
             236779200000000000 - 26000000000,
             27000000000},  // June 1993        <   June 1992       : dAT =   27 [s]
            {236779200000000000 - 26000000000,
             284040000000000000 - 25000000000,
             26000000000},  // June 1992        <   December 1990   : dAT =   26 [s]
            {284040000000000000 - 25000000000,
             315576000000000000 - 24000000000,
             25000000000},  // December 1990    <   December 1989   : dAT =   25 [s]
            {315576000000000000 - 24000000000,
             378734400000000000 - 23000000000,
             24000000000},  // December 1989    <   December 1987   : dAT =   24 [s]
            {378734400000000000 - 23000000000,
             457704000000000000 - 22000000000,
             23000000000},  // December 1987    <   June 1985       : dAT =   23 [s]
            {457704000000000000 - 22000000000,
             520862400000000000 - 21000000000,
             22000000000},  // June 1985        <   June 1983       : dAT =   22 [s]
            {520862400000000000 - 21000000000,
             552398400000000000 - 20000000000,
             21000000000},  // June 1983        <   June 1982       : dAT =   21 [s]
            {552398400000000000 - 20000000000,
             583934400000000000 - 19000000000,
             20000000000},  // June 1982        <   June 1981       : dAT =   20 [s]
            {583934400000000000 - 19000000000,
             631195200000000000 - 18000000000,
             19000000000},  // June 1981        <   December 1979   : dAT =   19 [s]
            {631195200000000000 - 18000000000,
             662731200000000000 - 17000000000,
             18000000000},  // December 1979    <   December 1978   : dAT =   18 [s]
            {662731200000000000 - 17000000000,
             694267200000000000 - 16000000000,
             17000000000},  // December 1978    <   December 1977   : dAT =   17 [s]
            {694267200000000000 - 16000000000,
             725803200000000000 - 15000000000,
             16000000000},  // December 1977    <   December 1976   : dAT =   16 [s]
            {725803200000000000 - 15000000000,
             757425600000000000 - 14000000000,
             15000000000},  // December 1976    <   December 1975   : dAT =   15 [s]
            {757425600000000000 - 14000000000,
             788961600000000000 - 13000000000,
             14000000000},  // December 1975    <   December 1974   : dAT =   14 [s]
            {788961600000000000 - 13000000000,
             820497600000000000 - 12000000000,
             13000000000},  // December 1974    <   December 1973   : dAT =   13 [s]
            {820497600000000000 - 12000000000,
             852033600000000000 - 11000000000,
             12000000000},  // December 1973    <   December 1972   : dAT =   12 [s]
            {852033600000000000 - 11000000000,
             867931200000000000 - 10000000000,
             11000000000},  // December 1972    <   June 1972       : dAT =   11 [s]
            {867931200000000000 - 10000000000,
             999999999999999999,
             10000000000}  // June 1972        <   Start           : dAT =   10 [s]
