...
Int64                           Instant::dAT_UTC                            (   const   Instant::Count&             aCount_UTC                                  )
{
    ...
    else
    {
        ...
        static const Array<Triple<Uint64, Uint64, Int64>> dATMap =
        {
            ...
            { 631195200000000000, 662731200000000000, 18000000000 },            // December 1979    <   December 1978   : dAT =   18 [s]
            { 662731200000000000, 694267200000000000, 17000000000 },            // December 1978    <   December 1977   : dAT =   17 [s]
            { 694267200000000000, 725803200000000000, 16000000000 },            // December 1977    <   December 1976   : dAT =   16 [s]
            { 725803200000000000, 757425600000000000, 15000000000 },            // December 1976    <   December 1975   : dAT =   15 [s]
            { 757425600000000000, 788961600000000000, 14000000000 },            // December 1975    <   December 1974   : dAT =   14 [s]
            { 788961600000000000, 820497600000000000, 13000000000 },            // December 1974    <   December 1973   : dAT =   13 [s]
            { 820497600000000000, 852033600000000000, 12000000000 },            // December 1973    <   December 1972   : dAT =   12 [s]
            { 852033600000000000, 867931200000000000, 11000000000 },            // December 1972    <   June 1972       : dAT =   11 [s]
            { 867931200000000000, 999999999999999999, 10000000000 }             // June 1972        <   Start           : dAT =   10 [s]
        } ;
...
Int64                           Instant::dAT_TAI                            (   const   Instant::Count&             aCount_TAI                                  )
{
    ...
    else
    {
        ...
        static const Array<Triple<Uint64, Uint64, Int64>> dATMap =
        {
            ...
            { 631195200000000000 - 18000000000, 662731200000000000 - 17000000000, 18000000000 },            // December 1979    <   December 1978   : dAT =   18 [s]
            { 662731200000000000 - 17000000000, 694267200000000000 - 16000000000, 17000000000 },            // December 1978    <   December 1977   : dAT =   17 [s]
            { 694267200000000000 - 16000000000, 725803200000000000 - 15000000000, 16000000000 },            // December 1977    <   December 1976   : dAT =   16 [s]
            { 725803200000000000 - 15000000000, 757425600000000000 - 14000000000, 15000000000 },            // December 1976    <   December 1975   : dAT =   15 [s]
            { 757425600000000000 - 14000000000, 788961600000000000 - 13000000000, 14000000000 },            // December 1975    <   December 1974   : dAT =   14 [s]
            { 788961600000000000 - 13000000000, 820497600000000000 - 12000000000, 13000000000 },            // December 1974    <   December 1973   : dAT =   13 [s]
            { 820497600000000000 - 12000000000, 852033600000000000 - 11000000000, 12000000000 },            // December 1973    <   December 1972   : dAT =   12 [s]
            { 852033600000000000 - 11000000000, 867931200000000000 - 10000000000, 11000000000 },            // December 1972    <   June 1972       : dAT =   11 [s]
            { 867931200000000000 - 10000000000, 999999999999999999,               10000000000 }             // June 1972        <   Start           : dAT =   10 [s]
        } ;
