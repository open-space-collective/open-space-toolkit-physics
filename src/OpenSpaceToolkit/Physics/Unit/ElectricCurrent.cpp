...
ElectricCurrent::ElectricCurrent(const Real& aValue, const ElectricCurrent::Unit& aUnit)
    : unit::Unit(unit::Unit::Type::ElectricCurrent, aValue),
      unit_(aUnit)
{
}
...
{
    return unit::Unit::isDefined() && (unit_ != ElectricCurrent::Unit::Undefined);
}
