...
TEST (Library_Physics_Environment_Objects_CelestialBodies_Earth, GetFrameAt)
{
...

    {
        ...
        {
            { { Angle::Degrees(0.0), Angle::Degrees(0.0), Length::Kilometers(0.01716) }, File::Path(Path::Parse("../test/Library/Physics/Environment/Objects/CelestialBodies/Earth/GetFrameAt/NED_ITRF 1.csv")), File::Path(Path::Parse("../test/Library/Physics/Environment/Objects/CelestialBodies/Earth/GetFrameAt/NED_GCRF 1.csv")) },
            { { Angle::Degrees(36.5), Angle::Degrees(-123.6), Length::Kilometers(-0.0379749) }, File::Path(Path::Parse("../test/Library/Physics/Environment/Objects/CelestialBodies/Earth/GetFrameAt/NED_ITRF 2.csv")), File::Path(Path::Parse("../test/Library/Physics/Environment/Objects/CelestialBodies/Earth/GetFrameAt/NED_GCRF 2.csv")) },
            { { Angle::Degrees(90.0), Angle::Degrees(123.456), Length::Kilometers(0.0136095) }, File::Path(Path::Parse("../test/Library/Physics/Environment/Objects/CelestialBodies/Earth/GetFrameAt/NED_ITRF 3.csv")), File::Path(Path::Parse("../test/Library/Physics/Environment/Objects/CelestialBodies/Earth/GetFrameAt/NED_GCRF 3.csv")) },
            { { Angle::Degrees(-90.0), Angle::Degrees(-95.31), Length::Kilometers(-0.0295348 ) }, File::Path(Path::Parse("../test/Library/Physics/Environment/Objects/CelestialBodies/Earth/GetFrameAt/NED_ITRF 4.csv")), File::Path(Path::Parse("../test/Library/Physics/Environment/Objects/CelestialBodies/Earth/GetFrameAt/NED_GCRF 4.csv")) }
        } ;
