...
TEST (Library_Physics_Time_Time, GetString)
{
...

    {
        ...
        EXPECT_EQ("00:00:00.000.000.000", Time(0, 0, 0, 0, 0, 0).getString()) ;
...
TEST (Library_Physics_Time_Time, Parse)
{
...

    {
        ...
        EXPECT_EQ(Time(12, 34, 56), Time::Parse("12:34:56")) ;

        EXPECT_EQ(Time(12, 34, 56, 100), Time::Parse("12:34:56.1")) ;
        EXPECT_EQ(Time(12, 34, 56, 120), Time::Parse("12:34:56.12")) ;
        EXPECT_EQ(Time(12, 34, 56, 123), Time::Parse("12:34:56.123")) ;

        EXPECT_EQ(Time(12, 34, 56, 123, 400), Time::Parse("12:34:56.123.4")) ;
        EXPECT_EQ(Time(12, 34, 56, 123, 450), Time::Parse("12:34:56.123.45")) ;
        EXPECT_EQ(Time(12, 34, 56, 123, 456), Time::Parse("12:34:56.123.456")) ;

        EXPECT_EQ(Time(12, 34, 56, 123, 456, 700), Time::Parse("12:34:56.123.456.7")) ;
        EXPECT_EQ(Time(12, 34, 56, 123, 456, 780), Time::Parse("12:34:56.123.456.78")) ;
...

    {
        ...
        EXPECT_ANY_THROW(Time::Parse("")) ;
        EXPECT_ANY_THROW(Time::Parse("abc")) ;
        EXPECT_ANY_THROW(Time::Parse("1:34:56")) ;
        EXPECT_ANY_THROW(Time::Parse("12:3:56")) ;
        EXPECT_ANY_THROW(Time::Parse("12:34:5")) ;
        EXPECT_ANY_THROW(Time::Parse("24:34:56")) ;
        EXPECT_ANY_THROW(Time::Parse("12:60:56")) ;
        EXPECT_ANY_THROW(Time::Parse("12:34:61")) ;
        EXPECT_ANY_THROW(Time::Parse("12:34:61.")) ;
        EXPECT_ANY_THROW(Time::Parse("-12:34:56")) ;
