...
{
    {
        const Array<Triple<File, Angle, Real>> referenceScenarios = {
            {File::Path(
                 Path::Parse("/app/test/OpenSpaceToolkit/Physics/Coordinate/Frame/Provider/TEME/Scenario_A/Scenario "
                             "ITRF_TEME.csv")
             ),
             Angle::Arcseconds(1.0),
             1e-9},
            {File::Path(
                 Path::Parse("/app/test/OpenSpaceToolkit/Physics/Coordinate/Frame/Provider/TEME/Scenario_B/Scenario "
                             "ITRF_TEME.csv")
             ),
