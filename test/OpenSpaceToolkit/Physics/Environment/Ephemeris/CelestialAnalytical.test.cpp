...
class OpenSpaceToolkit_Physics_Environment_Ephemeris_CelestialAnalytical : public ::testing::Test
{
   protected:
    Engine& engine_;
    Manager& manager_;

    OpenSpaceToolkit_Physics_Environment_Ephemeris_CelestialAnalytical()
        : engine_(Engine::Get()),
...
TEST_F(OpenSpaceToolkit_Physics_Environment_Ephemeris_CelestialAnalytical, Constructor)
{
    {
        EXPECT_NO_THROW(CelestialAnalytical sunEphemeris {Celestial::Type::Sun});
        EXPECT_NO_THROW(CelestialAnalytical moonEphemeris {Celestial::Type::Moon});
    }

    // Unsupported types throw

    {
        EXPECT_ANY_THROW(CelestialAnalytical earthEphemeris {Celestial::Type::Earth});
        EXPECT_ANY_THROW(CelestialAnalytical marsEphemeris {Celestial::Type::Mars});
        EXPECT_ANY_THROW(CelestialAnalytical undefinedEphemeris {Celestial::Type::Undefined});
    }

    // Repeated construction does not throw

    {
        const CelestialAnalytical firstSunEphemeris = {Celestial::Type::Sun};
        const CelestialAnalytical secondSunEphemeris = {Celestial::Type::Sun};
...
TEST_F(OpenSpaceToolkit_Physics_Environment_Ephemeris_CelestialAnalytical, Clone)
{
    {
        const CelestialAnalytical sunEphemeris = {Celestial::Type::Sun};

        const CelestialAnalytical* clonedSunEphemerisPtr = sunEphemeris.clone();

        EXPECT_TRUE(clonedSunEphemerisPtr != nullptr);
        EXPECT_EQ(Celestial::Type::Sun, clonedSunEphemerisPtr->getType());

        delete clonedSunEphemerisPtr;
    }
}

TEST_F(OpenSpaceToolkit_Physics_Environment_Ephemeris_CelestialAnalytical, IsDefined)
{
    {
        const CelestialAnalytical sunEphemeris = {Celestial::Type::Sun};
    ...
    {
        const CelestialAnalytical moonEphemeris = {Celestial::Type::Moon};

        EXPECT_TRUE(moonEphemeris.isDefined());
    }
}

TEST_F(OpenSpaceToolkit_Physics_Environment_Ephemeris_CelestialAnalytical, AccessFrame)
{
    {
        const CelestialAnalytical sunEphemeris = {Celestial::Type::Sun};
...
TEST_F(OpenSpaceToolkit_Physics_Environment_Ephemeris_CelestialAnalytical, GetType)
{
    {
        EXPECT_EQ(Celestial::Type::Sun, CelestialAnalytical(Celestial::Type::Sun).getType());
        EXPECT_EQ(Celestial::Type::Moon, CelestialAnalytical(Celestial::Type::Moon).getType());
    }
}

TEST_F(OpenSpaceToolkit_Physics_Environment_Ephemeris_CelestialAnalytical, SunPositionVersusSpice)
{
    {
...
TEST_F(OpenSpaceToolkit_Physics_Environment_Ephemeris_CelestialAnalytical, MoonPositionVersusSpice)
{
    {
        this->loadSpiceKernels();
...
TEST_F(OpenSpaceToolkit_Physics_Environment_Ephemeris_CelestialAnalytical, SunVelocityVersusSpice)
{
    {
        this->loadSpiceKernels();
...
TEST_F(OpenSpaceToolkit_Physics_Environment_Ephemeris_CelestialAnalytical, SunAnalytical)
{
    {
...
TEST_F(OpenSpaceToolkit_Physics_Environment_Ephemeris_CelestialAnalytical, MoonAnalytical)
{
    {
