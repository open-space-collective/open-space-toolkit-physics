...
/// @file           OpenSpaceToolkit/Physics/Environment/Gravitational/Moon.test.cpp
...
TEST (OpenSpaceToolkit_Physics_Environment_Gravitational_Moon, Constructor)
{
...

    {
        ...
        EXPECT_NO_THROW(std::make_shared<MoonGravitationalModel>(MoonGravitationalModel::Type::Spherical, Directory::Undefined())) ;
...
TEST (OpenSpaceToolkit_Physics_Environment_Gravitational_Moon, GetType)
{
...

    {
        ...
        EXPECT_EQ(MoonGravitationalModel::Type::Spherical, MoonGravitationalModel(MoonGravitationalModel::Type::Spherical).getType()) ;
