...
/// @file           OpenSpaceToolkit/Physics/Environment/Gravitational/Sun.test.cpp
...
TEST (OpenSpaceToolkit_Physics_Environment_Gravitational_Sun, Constructor)
{
...

    {
        ...
        EXPECT_NO_THROW(std::make_shared<SunGravitationalModel>(SunGravitationalModel::Type::Spherical, Directory::Undefined())) ;
...
TEST (OpenSpaceToolkit_Physics_Environment_Gravitational_Sun, GetType)
{
...

    {
        ...
        EXPECT_EQ(SunGravitationalModel::Type::Spherical, SunGravitationalModel(SunGravitationalModel::Type::Spherical).getType()) ;
