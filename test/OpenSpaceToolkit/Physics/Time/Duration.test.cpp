...
TEST(OpenSpaceToolkit_Physics_Time_Duration, GetNanoseconds)
{
    ...
    {
        const Duration duration = Duration::Weeks(12) + Duration::Days(15) + Duration::Hours(12) +
                                  Duration::Minutes(34) + Duration::Seconds(56) + Duration::Milliseconds(567) +
                                  Duration::Microseconds(890) + Duration::Nanoseconds(123);
...

    {
        ...
        {
            const Duration duration = Duration::Days(idx) + Duration::Hours(idx) + Duration::Minutes(idx) +
                                      Duration::Seconds(idx) + Duration::Milliseconds(idx) +
                                      Duration::Microseconds(idx) + Duration::Nanoseconds(idx);
...
TEST(OpenSpaceToolkit_Physics_Time_Duration, GetWeeks)
{
...

    {
        ...
        {
            const Duration duration = Duration::Weeks(idx) + Duration::Days(idx) + Duration::Hours(idx) +
                                      Duration::Minutes(idx) + Duration::Seconds(idx) + Duration::Milliseconds(idx) +
                                      Duration::Microseconds(idx) + Duration::Nanoseconds(idx);
...
{
    {
        ...
        EXPECT_NEAR(
            (24.0 * 60.0 * 60.0 * 1000000000.0), Duration(Int64(24) * 60 * 60 * 1000000000).inNanoseconds(), 1e-15
        );
        EXPECT_NEAR(
            (7.0 * 24.0 * 60.0 * 60.0 * 1000000000.0),
            Duration(Int64(7) * 24 * 60 * 60 * 1000000000).inNanoseconds(),
            1e-15
        );
        EXPECT_NEAR(
            (100.0 * 365.0 * 24.0 * 60.0 * 60.0 * 1000000000.0),
            Duration(Int64(100) * 365 * 24 * 60 * 60 * 1000000000).inNanoseconds(),
            1e-15
        );
    }
...
{
    {
        ...
        EXPECT_NEAR(
            (24.0 * 60.0 * 60.0 * 1000000.0), Duration(Int64(24) * 60 * 60 * 1000000000).inMicroseconds(), 1e-15
        );
        EXPECT_NEAR(
            (7.0 * 24.0 * 60.0 * 60.0 * 1000000.0),
            Duration(Int64(7) * 24 * 60 * 60 * 1000000000).inMicroseconds(),
            1e-15
        );
        EXPECT_NEAR(
            (100.0 * 365.0 * 24.0 * 60.0 * 60.0 * 1000000.0),
            Duration(Int64(100) * 365 * 24 * 60 * 60 * 1000000000).inMicroseconds(),
            1e-15
        );
    }
...
{
    {
        ...
        EXPECT_NEAR(
            (7.0 * 24.0 * 60.0 * 60.0 * 1000.0), Duration(Int64(7) * 24 * 60 * 60 * 1000000000).inMilliseconds(), 1e-15
        );
        EXPECT_NEAR(
            (100.0 * 365.0 * 24.0 * 60.0 * 60.0 * 1000.0),
            Duration(Int64(100) * 365 * 24 * 60 * 60 * 1000000000).inMilliseconds(),
            1e-15
        );
    }
...
{
    {
        ...
        EXPECT_NEAR(
            (100.0 * 365.0 * 24.0 * 60.0 * 60.0),
            Duration(Int64(100) * 365 * 24 * 60 * 60 * 1000000000).inSeconds(),
            1e-15
        );
    }
...
{
    {
        ...
        EXPECT_NEAR(
            (100.0 * 365.0 * 24.0 * 60.0), Duration(Int64(100) * 365 * 24 * 60 * 60 * 1000000000).inMinutes(), 1e-15
        );
    }
...
{
    {
        EXPECT_NEAR(
            (100.0 * 365.0 * 24.0 * 60.0 * 60.0 * 1000000000.0),
            Duration(Int64(100) * 365 * 24 * 60 * 60 * 1000000000).in(Time::Unit::Nanosecond),
            1e-15
        );
        EXPECT_NEAR(
            (100.0 * 365.0 * 24.0 * 60.0 * 60.0 * 1000000.0),
            Duration(Int64(100) * 365 * 24 * 60 * 60 * 1000000000).in(Time::Unit::Microsecond),
            1e-15
        );
        EXPECT_NEAR(
            (100.0 * 365.0 * 24.0 * 60.0 * 60.0 * 1000.0),
            Duration(Int64(100) * 365 * 24 * 60 * 60 * 1000000000).in(Time::Unit::Millisecond),
            1e-15
        );
        EXPECT_NEAR(
            (100.0 * 365.0 * 24.0 * 60.0 * 60.0),
            Duration(Int64(100) * 365 * 24 * 60 * 60 * 1000000000).in(Time::Unit::Second),
            1e-15
        );
        EXPECT_NEAR(
            (100.0 * 365.0 * 24.0 * 60.0),
            Duration(Int64(100) * 365 * 24 * 60 * 60 * 1000000000).in(Time::Unit::Minute),
            1e-15
        );
        EXPECT_NEAR(
            (100.0 * 365.0 * 24.0), Duration(Int64(100) * 365 * 24 * 60 * 60 * 1000000000).in(Time::Unit::Hour), 1e-15
        );
        EXPECT_NEAR((100.0 * 365.0), Duration(Int64(100) * 365 * 24 * 60 * 60 * 1000000000).in(Time::Unit::Day), 1e-15);
        EXPECT_NEAR(
            (100.0 * 365.0 / 7.0), Duration(Int64(100) * 365 * 24 * 60 * 60 * 1000000000).in(Time::Unit::Week), 1e-15
        );
    }
...
TEST(OpenSpaceToolkit_Physics_Time_Duration, ToString)
{
...

    {
        ...
        EXPECT_EQ(
            "01:02.000.000.000",
            (Duration::Minutes(+1.0) + Duration::Seconds(+2.0)).toString(Duration::Format::Standard)
        );
        EXPECT_EQ(
            "12:34.000.000.000",
            (Duration::Minutes(+12.0) + Duration::Seconds(+34.0)).toString(Duration::Format::Standard)
        );

        EXPECT_EQ(
            "01:02:03.000.000.000",
            (Duration::Hours(+1.0) + Duration::Minutes(+2.0) + Duration::Seconds(+3.0))
                .toString(Duration::Format::Standard)
        );
        EXPECT_EQ(
            "12:34:56.000.000.000",
            (Duration::Hours(+12.0) + Duration::Minutes(+34.0) + Duration::Seconds(+56.0))
                .toString(Duration::Format::Standard)
        );

        EXPECT_EQ(
            "1 01:02:03.000.000.000",
            (Duration::Days(+1.0) + Duration::Hours(+1.0) + Duration::Minutes(+2.0) + Duration::Seconds(+3.0))
                .toString(Duration::Format::Standard)
        );
        EXPECT_EQ(
            "3 12:34:56.000.000.000",
            (Duration::Days(+3.0) + Duration::Hours(+12.0) + Duration::Minutes(+34.0) + Duration::Seconds(+56.0))
                .toString(Duration::Format::Standard)
        );
        EXPECT_EQ(
            "7 12:34:56.000.000.000",
            (Duration::Days(+7.0) + Duration::Hours(+12.0) + Duration::Minutes(+34.0) + Duration::Seconds(+56.0))
                .toString(Duration::Format::Standard)
        );
        EXPECT_EQ(
            "14 12:34:56.000.000.000",
            (Duration::Days(+14.0) + Duration::Hours(+12.0) + Duration::Minutes(+34.0) + Duration::Seconds(+56.0))
                .toString(Duration::Format::Standard)
        );
        EXPECT_EQ(
            "99 12:34:56.000.000.000",
            (Duration::Days(+99.0) + Duration::Hours(+12.0) + Duration::Minutes(+34.0) + Duration::Seconds(+56.0))
                .toString(Duration::Format::Standard)
        );

        EXPECT_EQ(
            "1 01:02:03.123.456.789",
            (Duration::Days(+1.0) + Duration::Hours(+1.0) + Duration::Minutes(+2.0) + Duration::Seconds(+3.0) +
             Duration::Milliseconds(+123.0) + Duration::Microseconds(+456.0) + Duration::Nanoseconds(+789.0))
                .toString(Duration::Format::Standard)
        );
...

    {
        ...
        EXPECT_EQ(
            "PT12M34S", (Duration::Minutes(+12.0) + Duration::Seconds(+34.0)).toString(Duration::Format::ISO8601)
        );

        EXPECT_EQ(
            "PT1H2M3S",
            (Duration::Hours(+1.0) + Duration::Minutes(+2.0) + Duration::Seconds(+3.0))
                .toString(Duration::Format::ISO8601)
        );
        EXPECT_EQ(
            "PT12H34M56S",
            (Duration::Hours(+12.0) + Duration::Minutes(+34.0) + Duration::Seconds(+56.0))
        ...
        EXPECT_EQ(
            "P1DT1H2M",
            (Duration::Days(+1.0) + Duration::Hours(+1.0) + Duration::Minutes(+2.0)).toString(Duration::Format::ISO8601)
        );
        EXPECT_EQ(
            "P1DT1H2M3S",
            (Duration::Days(+1.0) + Duration::Hours(+1.0) + Duration::Minutes(+2.0) + Duration::Seconds(+3.0))
        ...
        EXPECT_EQ(
            "-PT1M2S", (-(Duration::Minutes(+1.0) + Duration::Seconds(+2.0))).toString(Duration::Format::ISO8601)
        );
        EXPECT_EQ(
            "-PT12M34S", (-(Duration::Minutes(+12.0) + Duration::Seconds(+34.0))).toString(Duration::Format::ISO8601)
        );
        ...
        EXPECT_EQ(
            "-P1DT1H2M",
            (-(Duration::Days(+1.0) + Duration::Hours(+1.0) + Duration::Minutes(+2.0)))
                .toString(Duration::Format::ISO8601)
        );
        EXPECT_EQ(
            "-P1DT1H2M3S",
...
TEST(OpenSpaceToolkit_Physics_Time_Duration, Between)
{
...

    {
        ...
        EXPECT_ANY_THROW(
            Duration::Between(Instant::DateTime(DateTime(2000, 1, 1, 0, 0, 0), Scale::UTC), Instant::Undefined())
        );
        EXPECT_ANY_THROW(
            Duration::Between(Instant::Undefined(), Instant::DateTime(DateTime(2000, 1, 1, 0, 0, 0), Scale::UTC))
        );
    }
}
...
TEST(OpenSpaceToolkit_Physics_Time_Duration, Parse)
{
...

    {
        ...
        EXPECT_EQ(
            (Duration::Minutes(+1.0) + Duration::Seconds(+2.0)),
            Duration::Parse("01:02.000.000.000", Duration::Format::Standard)
        );
        EXPECT_EQ(
            (Duration::Minutes(+12.0) + Duration::Seconds(+34.0)),
            Duration::Parse("12:34.000.000.000", Duration::Format::Standard)
        );

        EXPECT_EQ(
            (Duration::Hours(+1.0) + Duration::Minutes(+2.0) + Duration::Seconds(+3.0)),
            Duration::Parse("01:02:03.000.000.000", Duration::Format::Standard)
        );
        EXPECT_EQ(
            (Duration::Hours(+12.0) + Duration::Minutes(+34.0) + Duration::Seconds(+56.0)),
            Duration::Parse("12:34:56.000.000.000", Duration::Format::Standard)
        );

        EXPECT_EQ(
            (Duration::Days(+1.0) + Duration::Hours(+1.0) + Duration::Minutes(+2.0) + Duration::Seconds(+3.0)),
            Duration::Parse("1 01:02:03.000.000.000", Duration::Format::Standard)
        );
        EXPECT_EQ(
            (Duration::Days(+3.0) + Duration::Hours(+12.0) + Duration::Minutes(+34.0) + Duration::Seconds(+56.0)),
            Duration::Parse("3 12:34:56.000.000.000", Duration::Format::Standard)
        );
        EXPECT_EQ(
            (Duration::Days(+7.0) + Duration::Hours(+12.0) + Duration::Minutes(+34.0) + Duration::Seconds(+56.0)),
            Duration::Parse("7 12:34:56.000.000.000", Duration::Format::Standard)
        );
        EXPECT_EQ(
            (Duration::Days(+14.0) + Duration::Hours(+12.0) + Duration::Minutes(+34.0) + Duration::Seconds(+56.0)),
            Duration::Parse("14 12:34:56.000.000.000", Duration::Format::Standard)
        );
        EXPECT_EQ(
            (Duration::Days(+99.0) + Duration::Hours(+12.0) + Duration::Minutes(+34.0) + Duration::Seconds(+56.0)),
            Duration::Parse("99 12:34:56.000.000.000", Duration::Format::Standard)
        );

        EXPECT_EQ(
            (Duration::Days(+1.0) + Duration::Hours(+1.0) + Duration::Minutes(+2.0) + Duration::Seconds(+3.0) +
             Duration::Milliseconds(+123.0) + Duration::Microseconds(+456.0) + Duration::Nanoseconds(+789.0)),
            Duration::Parse("1 01:02:03.123.456.789", Duration::Format::Standard)
        );
        ...
        for (auto idx = 0; idx < 100000; idx += 10)
        {
            ...
            EXPECT_EQ(
                duration, Duration::Parse(duration.toString(Duration::Format::Standard), Duration::Format::Standard)
            );
            EXPECT_EQ(
                (-duration),
                Duration::Parse((-duration).toString(Duration::Format::Standard), Duration::Format::Standard)
            );
        }
    }
...

    {
        ...
        EXPECT_EQ(
            (Duration::Minutes(+1.0) + Duration::Seconds(+2.0)), Duration::Parse("PT1M2S", Duration::Format::ISO8601)
        );
        EXPECT_EQ(
            (Duration::Minutes(+12.0) + Duration::Seconds(+34.0)),
            Duration::Parse("PT12M34S", Duration::Format::ISO8601)
        );

        EXPECT_EQ(
            (Duration::Hours(+1.0) + Duration::Minutes(+2.0) + Duration::Seconds(+3.0)),
            Duration::Parse("PT1H2M3S", Duration::Format::ISO8601)
        );
        EXPECT_EQ(
            (Duration::Hours(+12.0) + Duration::Minutes(+34.0) + Duration::Seconds(+56.0)),
            Duration::Parse("PT12H34M56S", Duration::Format::ISO8601)
        );

        EXPECT_EQ(Duration::Seconds(+123.0), Duration::Parse("PT123S", Duration::Format::ISO8601));
        EXPECT_EQ(
            (Duration::Minutes(+123.0) + Duration::Seconds(+45.0)),
            Duration::Parse("PT123M45S", Duration::Format::ISO8601)
        );
        EXPECT_EQ(
            (Duration::Hours(+123.0) + Duration::Minutes(+45.0) + Duration::Seconds(+60.0)),
            Duration::Parse("PT123H45M60S", Duration::Format::ISO8601)
        );
        ...
        EXPECT_EQ(
            (Duration::Days(+1.0) + Duration::Hours(+1.0) + Duration::Minutes(+2.0)),
            Duration::Parse("P1DT1H2M", Duration::Format::ISO8601)
        );
        EXPECT_EQ(
            (Duration::Days(+1.0) + Duration::Hours(+1.0) + Duration::Minutes(+2.0) + Duration::Seconds(+3.0)),
            Duration::Parse("P1DT1H2M3S", Duration::Format::ISO8601)
        );
        EXPECT_EQ(
            (Duration::Days(+3.0) + Duration::Hours(+12.0) + Duration::Minutes(+34.0) + Duration::Seconds(+56.0)),
            Duration::Parse("P3DT12H34M56S", Duration::Format::ISO8601)
        );
        EXPECT_EQ(
            (Duration::Days(+7.0) + Duration::Hours(+12.0) + Duration::Minutes(+34.0) + Duration::Seconds(+56.0)),
            Duration::Parse("P7DT12H34M56S", Duration::Format::ISO8601)
        );
        EXPECT_EQ(
            (Duration::Days(+14.0) + Duration::Hours(+12.0) + Duration::Minutes(+34.0) + Duration::Seconds(+56.0)),
            Duration::Parse("P14DT12H34M56S", Duration::Format::ISO8601)
        );
        EXPECT_EQ(
            (Duration::Days(+99.0) + Duration::Hours(+12.0) + Duration::Minutes(+34.0) + Duration::Seconds(+56.0)),
            Duration::Parse("P99DT12H34M56S", Duration::Format::ISO8601)
        );

        EXPECT_EQ(
            (Duration::Days(+1.0) + Duration::Hours(+1.0) + Duration::Minutes(+2.0) + Duration::Seconds(+3.0) +
             Duration::Milliseconds(+123.0) + Duration::Microseconds(+456.0) + Duration::Nanoseconds(+789.0)),
            Duration::Parse("P1DT1H2M3.123456789S", Duration::Format::ISO8601)
        );
        ...
        EXPECT_EQ(
            (-(Duration::Minutes(+1.0) + Duration::Seconds(+2.0))),
            Duration::Parse("-PT1M2S", Duration::Format::ISO8601)
        );
        EXPECT_EQ(
            (-(Duration::Minutes(+12.0) + Duration::Seconds(+34.0))),
            Duration::Parse("-PT12M34S", Duration::Format::ISO8601)
        ...
        EXPECT_EQ((-(Duration::Days(+1.0))), Duration::Parse("-P1D", Duration::Format::ISO8601));
        EXPECT_EQ(
            (-(Duration::Days(+1.0) + Duration::Hours(+1.0))), Duration::Parse("-P1DT1H", Duration::Format::ISO8601)
        );
        EXPECT_EQ(
            (-(Duration::Days(+1.0) + Duration::Hours(+1.0) + Duration::Minutes(+2.0))),
            Duration::Parse("-P1DT1H2M", Duration::Format::ISO8601)
