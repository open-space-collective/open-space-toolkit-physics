                                    ...
                                    for (const auto microsecond : microseconds)
                                    {
                                        for (const auto nanosecond : nanoseconds)
                                        {
                                            for (const auto scale : scales)
                                            {
                                                ...
                                                {
                                                    EXPECT_FALSE(
                                                        Instant::DateTime(dateTime, scale) == Instant::DateTime(
                                                                                                  DateTime(
                                                                                                      year,
                                                                                                      month,
                                                                                                      day,
                                                ...
                                                if (scale != Scale::UTC)
                                                {
                                                    if ((scale == Scale::GPST) && (dateTime.accessDate().getYear() ==
                                                                                   1981))  // Because GPST == UTC @ 1981
                                                    {
                                                        continue;
                                                    }
                                                    ...
                                                    EXPECT_FALSE(
                                                        Instant::DateTime(dateTime, scale) ==
                                                        Instant::DateTime(dateTime, Scale::UTC)
                                                    );
                                                }
                                            }
                                        }
                                    ...
                                    for (const auto microsecond : microseconds)
                                    {
                                        for (const auto nanosecond : nanoseconds)
                                        {
                                            for (const auto scale : scales)
                                            {
                                                ...
                                                EXPECT_FALSE(
                                                    Instant::Undefined() == Instant::DateTime(dateTime, scale)
                                                );
                                            }
                                        }
                                    }
...
TEST(OpenSpaceToolkit_Physics_Time_Instant, LessThanOperator)
{
...

    {
        ...
        {
            EXPECT_TRUE(
                Instant::DateTime(DateTime(2000, 1, 1, 12, 0, 0), scale) <
                Instant::DateTime(DateTime(2001, 1, 1, 12, 0, 0), scale)
            );
            EXPECT_TRUE(
                Instant::DateTime(DateTime(1999, 1, 1, 12, 0, 0), scale) <
                Instant::DateTime(DateTime(2000, 1, 1, 12, 0, 0), scale)
            );
        }
    }
        ...
        for (const auto year : years)
        {
            for (const auto month : months)
            {
                for (const auto day : days)
                {
                    ...
                    {
                        EXPECT_EQ(
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0), scale),
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0), scale) + Duration::Zero()
                        );

                        EXPECT_EQ(
                            Instant::DateTime(DateTime(year, month, day, 11, 59, 59, 999, 999, 999), scale),
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0), scale) + Duration::Nanoseconds(-1)
                        );
                        EXPECT_EQ(
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0, 0, 0, 1), scale),
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0), scale) + Duration::Nanoseconds(+1)
                        );

                        EXPECT_EQ(
                            Instant::DateTime(DateTime(year, month, day, 11, 59, 59, 999, 999), scale),
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0), scale) + Duration::Microseconds(-1)
                        );
                        EXPECT_EQ(
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0, 0, 1), scale),
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0), scale) + Duration::Microseconds(+1)
                        );

                        EXPECT_EQ(
                            Instant::DateTime(DateTime(year, month, day, 11, 59, 59, 999), scale),
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0), scale) + Duration::Milliseconds(-1)
                        );
                        EXPECT_EQ(
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0, 1), scale),
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0), scale) + Duration::Milliseconds(+1)
                        );

                        EXPECT_EQ(
                            Instant::DateTime(DateTime(year, month, day, 11, 59, 59), scale),
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0), scale) + Duration::Seconds(-1)
                        );
                        EXPECT_EQ(
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 1), scale),
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0), scale) + Duration::Seconds(+1)
                        );

                        EXPECT_EQ(
                            Instant::DateTime(DateTime(year, month, day, 11, 59, 0), scale),
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0), scale) + Duration::Minutes(-1)
                        );
                        EXPECT_EQ(
                            Instant::DateTime(DateTime(year, month, day, 12, 1, 0), scale),
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0), scale) + Duration::Minutes(+1)
                        );

                        EXPECT_EQ(
                            Instant::DateTime(DateTime(year, month, day, 11, 0, 0), scale),
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0), scale) + Duration::Hours(-1)
                        );
                        EXPECT_EQ(
                            Instant::DateTime(DateTime(year, month, day, 13, 0, 0), scale),
                            Instant::DateTime(DateTime(year, month, day, 12, 0, 0), scale) + Duration::Hours(+1)
                        );
                    }
                }
                            ...
                            for (const auto second : seconds)
                            {
                                for (const auto scale : scales)
                                {
                                    const Instant instant = Instant::DateTime(
                                        DateTime(year, month, day, hour, minute, second, 6, 7, 8), scale
                                    );

                                    EXPECT_EQ(
                                        DateTime(year, month, day, hour, minute, second, 6, 7, 8),
                                        instant.getDateTime(scale)
                                    );
                                }
                            }
                        }
...
TEST(OpenSpaceToolkit_Physics_Time_Instant, GetLeapSecondCount)
{
    ...
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("2016-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        36
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("2015-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        35
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("2012-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        34
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("2008-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        33
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("2005-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        32
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1998-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        31
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1997-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        30
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1995-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        29
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1994-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        28
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1993-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        27
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1992-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        26
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1990-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        25
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1989-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        24
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1987-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        23
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1985-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        22
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1983-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        21
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1982-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        20
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1981-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        19
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1979-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        18
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1978-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        17
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1977-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        16
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1976-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        15
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1975-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        14
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1974-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        13
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1973-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        12
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1972-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        11
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1972-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(1.0))
            .getLeapSecondCount(),
        10
    );

    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("2016-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        36 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("2015-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        35 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("2012-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        34 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("2008-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        33 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("2005-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        32 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1998-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        31 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1997-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        30 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1995-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        29 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1994-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        28 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1993-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        27 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1992-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        26 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1990-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        25 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1989-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        24 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1987-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        23 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1985-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        22 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1983-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        21 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1982-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        20 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1981-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        19 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1979-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        18 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1978-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        17 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1977-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        16 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1976-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        15 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1975-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        14 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1974-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        13 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1973-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        12 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1972-12-31 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        11 + 1
    );
    EXPECT_EQ(
        (Instant::DateTime(DateTime::Parse("1972-06-30 23:59:59"), Scale::UTC) + Duration::Seconds(2.0))
            .getLeapSecondCount(),
        10 + 1
    );
}
...
TEST(OpenSpaceToolkit_Physics_Time_Instant, ToString)
{
...

    {
        ...
        {
            EXPECT_EQ(
                String::Format("2000-01-01 12:00:00 [{}]", StringFromScale(scale)),
                Instant::DateTime(DateTime(2000, 1, 1, 12, 0, 0, 0, 0, 0), scale).toString(scale)
            );
            EXPECT_EQ(
                String::Format("2000-01-01 11:59:59.999.999.999 [{}]", StringFromScale(scale)),
                Instant::DateTime(DateTime(2000, 1, 1, 11, 59, 59, 999, 999, 999), scale).toString(scale)
            );
            EXPECT_EQ(
                String::Format("2000-01-01 12:00:00.000.000.001 [{}]", StringFromScale(scale)),
                Instant::DateTime(DateTime(2000, 1, 1, 12, 0, 0, 0, 0, 1), scale).toString(scale)
            );

            EXPECT_EQ(
                String::Format("1999-01-01 00:00:00 [{}]", StringFromScale(scale)),
                Instant::DateTime(DateTime(1999, 1, 1, 0, 0, 0, 0, 0, 0), scale).toString(scale)
            );
            EXPECT_EQ(
                String::Format("2000-01-01 00:00:00 [{}]", StringFromScale(scale)),
                Instant::DateTime(DateTime(2000, 1, 1, 0, 0, 0, 0, 0, 0), scale).toString(scale)
            );
            EXPECT_EQ(
                String::Format("2001-01-01 00:00:00 [{}]", StringFromScale(scale)),
                Instant::DateTime(DateTime(2001, 1, 1, 0, 0, 0, 0, 0, 0), scale).toString(scale)
            );

            EXPECT_EQ(
                String::Format("2018-01-02 03:04:05.006.007.008 [{}]", StringFromScale(scale)),
                Instant::DateTime(DateTime(2018, 1, 2, 3, 4, 5, 6, 7, 8), scale).toString(scale)
            );

            EXPECT_EQ(
                String::Format("1981-01-01 00:00:00 [{}]", StringFromScale(scale)),
                Instant::DateTime(DateTime(1981, 1, 1, 0, 0, 0, 0, 0, 0), scale).toString(scale)
            );
            EXPECT_EQ(
                String::Format("2030-12-31 23:59:59.999.999.999 [{}]", StringFromScale(scale)),
                Instant::DateTime(DateTime(2030, 12, 31, 23, 59, 59, 999, 999, 999), scale).toString(scale)
            );
        }
    }
    ...
    // UTC ISO8601
    {
        EXPECT_EQ(
            ...
            Instant::DateTime(DateTime(2000, 1, 1, 12, 0, 0, 0, 0, 0), Scale::UTC)
                .toString(Scale::UTC, DateTime::Format::ISO8601)
        );
        EXPECT_EQ(
            "2000-01-01T11:59:59.999999999Z",
            Instant::DateTime(DateTime(2000, 1, 1, 11, 59, 59, 999, 999, 999), Scale::UTC)
                .toString(Scale::UTC, DateTime::Format::ISO8601)
        );
        EXPECT_EQ(
            "2000-01-01T12:00:00.000000001Z",
            Instant::DateTime(DateTime(2000, 1, 1, 12, 0, 0, 0, 0, 1), Scale::UTC)
                .toString(Scale::UTC, DateTime::Format::ISO8601)
        );

        EXPECT_EQ(
            "1999-01-01T00:00:00Z",
            Instant::DateTime(DateTime(1999, 1, 1, 0, 0, 0, 0, 0, 0), Scale::UTC)
                .toString(Scale::UTC, DateTime::Format::ISO8601)
        );
        EXPECT_EQ(
            "2000-01-01T00:00:00Z",
            Instant::DateTime(DateTime(2000, 1, 1, 0, 0, 0, 0, 0, 0), Scale::UTC)
                .toString(Scale::UTC, DateTime::Format::ISO8601)
        );
        EXPECT_EQ(
            "2001-01-01T00:00:00Z",
            Instant::DateTime(DateTime(2001, 1, 1, 0, 0, 0, 0, 0, 0), Scale::UTC)
                .toString(Scale::UTC, DateTime::Format::ISO8601)
        );

        EXPECT_EQ(
            "2018-01-02T03:04:05.006007008Z",
            Instant::DateTime(DateTime(2018, 1, 2, 3, 4, 5, 6, 7, 8), Scale::UTC)
                .toString(Scale::UTC, DateTime::Format::ISO8601)
        );

        EXPECT_EQ(
            "1981-01-01T00:00:00Z",
            Instant::DateTime(DateTime(1981, 1, 1, 0, 0, 0, 0, 0, 0), Scale::UTC)
                .toString(Scale::UTC, DateTime::Format::ISO8601)
        );
        EXPECT_EQ(
            "2030-12-31T23:59:59.999999999Z",
            Instant::DateTime(DateTime(2030, 12, 31, 23, 59, 59, 999, 999, 999), Scale::UTC)
                .toString(Scale::UTC, DateTime::Format::ISO8601)
        );
    }

    {
        for (auto const& scale : scales)
        {
            EXPECT_EQ("Undefined", Instant::Undefined().toString(scale));
        }
    }
                                    ...
                                    for (const auto microsecond : microseconds)
                                    {
                                        for (const auto nanosecond : nanoseconds)
                                        {
                                            for (const auto scale : scales)
                                            {
                                                ...
                                                EXPECT_EQ(
                                                    dateTime, Instant::DateTime(dateTime, scale).getDateTime(scale)
                                                );
                                            }
                                        }
                                    }
