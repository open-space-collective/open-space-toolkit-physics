...
# Accept Unix (.a) and Windows (.lib) library names and handle debug/release variants.
FIND_LIBRARY (
    GEOGRAPHICLIB_LIBRARY_RELEASE
    NAMES "GeographicLib-i" "GeographicLib" "Geographic" "libGeographic"
    PATHS ${GEOGRAPHICLIB_ROOT_DIR}
    PATH_SUFFIXES "lib" "lib64"
)

FIND_LIBRARY (
    GEOGRAPHICLIB_LIBRARY_DEBUG
    NAMES "GeographicLib_d-i" "GeographicLib_d" "GeographicLibd" "GeographicLib-i" "GeographicLib"
    PATHS ${GEOGRAPHICLIB_ROOT_DIR}
    PATH_SUFFIXES "debug/lib" "lib" "lib64"
)

IF (GEOGRAPHICLIB_LIBRARY_RELEASE AND GEOGRAPHICLIB_LIBRARY_DEBUG)
    SET (GEOGRAPHICLIB_LIBRARIES optimized ${GEOGRAPHICLIB_LIBRARY_RELEASE} debug ${GEOGRAPHICLIB_LIBRARY_DEBUG})
    SET (GEOGRAPHICLIB_LIBRARY ${GEOGRAPHICLIB_LIBRARY_RELEASE})
ELSEIF (GEOGRAPHICLIB_LIBRARY_RELEASE)
    SET (GEOGRAPHICLIB_LIBRARIES ${GEOGRAPHICLIB_LIBRARY_RELEASE})
    SET (GEOGRAPHICLIB_LIBRARY ${GEOGRAPHICLIB_LIBRARY_RELEASE})
ELSEIF (GEOGRAPHICLIB_LIBRARY_DEBUG)
    SET (GEOGRAPHICLIB_LIBRARIES ${GEOGRAPHICLIB_LIBRARY_DEBUG})
    SET (GEOGRAPHICLIB_LIBRARY ${GEOGRAPHICLIB_LIBRARY_DEBUG})
ELSE ()
    SET (GEOGRAPHICLIB_LIBRARY GEOGRAPHICLIB_LIBRARY-NOTFOUND)
ENDIF ()
