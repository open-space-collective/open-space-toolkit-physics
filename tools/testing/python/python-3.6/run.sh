...
run_container ()
{
    ...
    --volume="${project_directory}/lib/libopen-space-toolkit-physics.so.1:/usr/local/lib/python3.6/site-packages/OpenSpaceToolkit/Physics/libopen-space-toolkit-physics.so.1:ro" \
